...
<%column_width_in_chars=[108,8,8]%>			        <!--Lebar masing-masing kolom line item dalam jumlah huruf/karakter-->
...
<!--================================================================== EDITABLE AREA ===============================================================-->
			...
			<%mynotes = prod.po_line_note%>

			%if prod.po_line_note:
				<%xnotes = prod_line_desc + ' : ' + mynotes[:90]%>
			%else:
				<%xnotes = prod_line_desc%>
			%endif
			<%str_holder.append(xnotes)%>
				    ...
				    <tr>
                        <td>
       		                <table class="table" cellpadding="2">
                                <tbody>
                                    <tr height="10px">
										<td style="width: 2%;" class="table_border">No</td>
			    ...
			    %for line_no in range (current_line,last_line):
				    %if line_no < total_lines_print:
                                ...
                                <!--Cetak line item yang telah diproses dari dokumen yang dimaksud-->
                                    <tr>
										<td class="table_line" style="text-align: right; height:${line_item_height}px; padding-left:4px;">
		                                ${no_urut}.
		                                </td>
...
####################################################################################################################################################-->
                    ...
                    <tr>
                        <td colspan="5" rowspan="1" style="font-size: 10px;">
                            ...
                            - ${ins.purchase_id.order_number or '' | entity}
                        </td>
