            ...
            <td colspan="5">
                ...
                <table>
                    <tr>
                        ...
                        <td style="vertical-align: top; width: 800px; font-size:${font_size}px">${inv.partner_id and inv.partner_id.name or ''|entity}</td>
                    </tr>
                    <tr>
...
####################################################################################################################################################-->
        ...
        <tr>
            ...
            ${current_page >= total_page and 'Dharmakumara' or ''}
            </div>
            <td>
            </td>
            <td>
