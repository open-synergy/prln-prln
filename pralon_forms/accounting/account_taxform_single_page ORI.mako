            ...
            <td style="vertical-align: top; border-right: 1px solid black;" colspan="7">
                ...
                <table style="border-collapse: collapse; margin-left: 5px; height: 64px;">
                        ...
                        %for p in lines[:4]:
                            ...
                            %else:
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="2" rowspan="1" style="text-align: left; border-right: 1px solid black; border-left: 1px solid black; padding-left: 5px;">Rp.
                                        </td>
                                        <td colspan="2" rowspan="1" style="text-align: left; border-right: 1px solid black; border-left: 1px solid black; padding-left: 5px;">Rp.
                                        </td>
                                    </tr>
                    ...
                    <tr>
                        ...
                        <td style="border-bottom:1px dashed; width: 200px;" colspan="5">Tjiam Wahyu
                        </td>
                        <td style="width: 80px;">
                        </td>
                    </tr>
