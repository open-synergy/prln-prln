...
%for inv in objects:
  ...
  %else:
    ...
    <body style="font-size:12px;font-family:Sans-Serif;">
      <table style="text-align: left; width: 733px;" border="0" cellpadding="2" cellspacing="2">
        <tbody>
          <tr>
              ...
              <table style="text-align: left; width: 100%;" border="0" cellpadding="2" cellspacing="2">
                <tbody>
                  <tr>
                    ...
                    <td style="vertical-align: top;"><br/></td>
                    <td style="vertical-align: top;"><br/></td>
                    <td style="vertical-align: top; width: 20px;"><br/></td>
                      ...
                      <table style="font-size:12px;" width="461px">
                        <tbody>
                          ...
                          <tr style="vertical-align: top; font-size: 10px;">
                            ...
                            <td></td>
                            <td>Rp.&nbsp;</td>
                            <td style="text-align:right;">${bea_materai and formatLang(bea_materai) or '' | n}</td>
                          </tr>
                          <tr style="vertical-align: top; font-size: 10px;">
                            <td>Total</td>
                            <td>:</td>
                  ...
                  <tr style="height: 20px;">
                    <td style="vertical-align: top;"><br/></td>
                    <td style="vertical-align: top; font-size: 18px; font-weight: bold; width: 30px;">Rp.&nbsp;</td>
                    <td colspan="2" rowspan="1" style="vertical-align: top; font-size: 18px;"><b>${total and formatLang(total) or '' | entity}</b></td>
                    <td style="vertical-align: top;"><br/></td>
                  ...
                  <tr>
                    ...
                    <td colspan="3" rowspan="1" style="vertical-align: top; font-size: 9px; width: 208px; ">
                      <fieldset style="border: 1px solid ; padding: 3px;">PEMBAYARAN DENGAN GIRO, CEK, DIANGGAP SAH APABILA CEK, GIRO TERSEBUT SUDAH DICAIRKAN.<br/></fieldset>
                    </td>
                    <td style="vertical-align: top; align: center;"><br /><br/><br/><br/><br />&nbsp;&nbsp;&nbsp;Gunawan Rusli</td>
                    <td style="vertical-align: top;"><br/></td>
                    <td style="vertical-align: top;"><br/></td>
                    <td style="vertical-align: top;"><br/></td-->
