...
%for tax in objects :
    ...
    <!--Proses cetak dokumen 3 halaman-->
...
<center><h2 style="width: ${page_width}px; font-size: 20px; margin: 0px; padding: 3px;"><b>FAKTUR PAJAK</b></h2></center>

<table style="text-align: left; width: ${page_width}px; height: 925px; margin: 0px; padding: 0px; border-right: 1px solid black; border-left: 1px solid black; border-top: 1px solid black; border-bottom: 1px solid black; border-collapse:collapse;" cellpadding="0" cellspacing="0">
	<tbody>
