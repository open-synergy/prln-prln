...
<%page_width = 812.598425%>						    <!--Lebar formulir yang umum digunakan sebagai lebar tabel utama-->
...
<center><h2 style="width: ${page_width}px; font-size: 20px; margin: 2px; padding: 2px;"><b>FAKTUR PAJAK</b></h2></center>

<table style="text-align: left; width: ${page_width}px; height: 925px; margin: 0; padding: 0; border-right: 1px solid black; border-left: 1px solid black; border-top: 1px solid black; border-bottom: 1px solid black; border-collapse:collapse;" cellpadding="0" cellspacing="0">
	<tbody>
...
####################################################################################################################################################-->
        ...
        <tr height="28px">
            <td style="border-bottom: 1px solid black; border-top: 1px solid black; border-right: 1px solid black; width: ${page_width}px;" colspan="7">
                <table>
                    <tr>
                        <td style="vertical-align: top; width: 283px;">Kode dan Nomor Seri Faktur Pajak</td>
                        <td style="vertical-align: top; width: 2px;">:</td>
                        <td style="vertical-align: top; width: 400px ">${tax.trx_code or ''}.${tax.branch_code or ''}-${tax.taxform_id or ''}</td>
                        <td  style="text-align: right; vertical-align: top;">
                        Halaman ${current_page} / ${total_page}
                        </td>
                    </tr>
        ...
        <tr height="28px">
            <td style="border-bottom: 1px solid black; border-top: 1px solid black; border-right: 1px solid black; width: ${page_width}px;" colspan="7">
                <table>
                    <tr>
                        <td style="vertical-align: top;" colspan="3"><b>Pengusaha Kena Pajak</b></td>
                    </tr>
                </table>
            </td>
        </tr>
        <tr height="86px">
            <td style="border-bottom: 1px solid black; border-top: 1px solid black; border-right: 1px solid black; width: ${page_width}px;" colspan="7">
                <table>
                    <tr>
                        <td style="vertical-align: top; width: 283px;">Nama</td>
        ...
        <tr height="28px">
            <td style="border-bottom: 1px solid black; border-top: 1px solid black; border-right: 1px solid black; width: ${page_width}px;" colspan="7">
                <table>
                    <tr>
                        <td style="vertical-align: top;" colspan="7"><b>Pembeli Barang Kena Pajak / Penerima Jasa Kena Pajak</b></td>
                    </tr>
                </table>
            </td>
        </tr>
        <tr height="86px">
            <td style="width: ${page_width}px; border: 1px solid black;" colspan="7">
                <table>
                    <tr>
                        <td style="vertical-align: top; width: 283px;">Nama</td>
                        <td style="vertical-align: top; width: 5px;">:</td>
                        <% xtitle = '' %>
						%if tax.partner_id.title.name:
							<% xtitle = tax.partner_id.title.name + '. '%>
						%endif
                        <td style="vertical-align: top;"> <b>${xtitle} ${tax.partner_id and tax.partner_id.name or ''}</b>
                        </td>
                    </tr>
                    <tr>
                        <td style="vertical-align: top;">Alamat</td>
...
####################################################################################################################################################-->
        ...
        <tr>
            <td colspan="7" rowspan="1" style="vertical-align: top; border-right: 1px solid black;">
                    ...
                    <tr>
					    <td colspan="15">
        					...
        					<tbody>
                                ...
                                <tr>
                                    <td style="width: 5%; font-family: Sans-Serif; border-top: 1px solid black; border-right: 1px solid black; border-bottom: 1px solid black; font-weight: bold; font-size: 15px; padding-right: 3px; text-align: center; border-spacing: 0px;">No.<br>
                                    </td>
                                    <td style="width: 50%; font-family: Sans-Serif; font-weight: bold; font-size: 15px;" class="table_border" colspan="3">Nama Barang Kena Pajak/Jasa Kena Pajak<br>
                                    </td>
                                    <td style="width: 35%; font-family: Sans-Serif; border-top: 1px solid black; border-bottom: 1px solid black; font-weight: bold; font-size: 15px; padding-right: 3px; text-align: center; border-spacing: 0px;" colspan="4">Harga Jual/Penggantian/Uang Muka/Termin (Rp)<br>
                                    </td>
                                </tr>
			    ...
			    %for line_no in range (current_line,last_line):
				    %if line_no < total_lines_print:
                        ...
                        %endif
                                ...
                                <tr>
                                    <td style="text-align: center; height:${line_item_height}px; border-right: 1px solid black;">
                                    ...
                                    <td style="text-align: left; height:${line_item_height}px; border-right: 1px solid black;">
			    ...
			    %endfor
			        ...
			        <%current_line = last_line%>
								...
								<tr>
                                    ...
                                    <td style="width: 50%; border-right: 1px solid black;" colspan="3">
                                    </td>
...
####################################################################################################################################################-->
                    ...
                    <tr>
                        <td colspan="7" rowspan="1" style="height:25px; padding-left: 4px; vertical-align: middle; border-right: 1px solid black; border-top: 1px solid black; border-bottom: 1px solid black;">
                            <div style="width: 510px;">
                               %if tax.trx_type == "hargajual":
                                    Harga Jual<s>/Penggantian/Uang Muka/Termin</s> **)
                                %elif tax.trx_type == "penggantian":
                                    <s>Harga Jual</s>Penggantian<s>/Uang Muka/Termin</s> **)
                                %elif tax.trx_type == "uangmuka":
                                    <s>Harga Jual/Penggantian/</s>Uang Muka<s>/Termin</s> **)
                                %elif tax.trx_type == "termin":
                                    <s>Harga Jual/Penggantian/Uang Muka/</s>Termin **)
                                %else:
                                    Harga Jual/Penggantian/Uang Muka/Termin **)
                                %endif
                        </div>
                        </td>
                        <td style="border-bottom: 1px solid black; border-top: 1px solid black; vertical-align: middle;">
                        ...
                        <td style="vertical-align: middle; text-align: right; padding-right: 4px; border-top: 1px solid black; border-bottom: 1px solid black;">
                    ...
                    <!--Area Potongan Harga-->
                    <tr>
                        <td colspan="7" rowspan="1" style="height:25px; padding-left: 4px; vertical-align: middle; border-right: 1px solid black; border-top: 1px solid black; border-bottom:1px solid black;">Dikurangi Potongan Harga
                        </td>
                        <td style="border-bottom: 1px solid black; border-top: 1px solid black; vertical-align: top; text-align:left;">
                        </td>
                        <td style="border-bottom: 1px solid black; text-align: left;">Rp.
                        </td>
                        <td style="vertical-align: middle; text-align: right; padding-right: 8px; border-top: 1px solid black; border-bottom: 1px solid black; text-align: right;">
                        %if current_page == total_page:
                    ...
                    <!-- Area Uang Muka-->
                    <tr>
                        <td colspan="7" rowspan="1" style="height:25px; padding-left: 4px; vertical-align: middle; border-right: 1px solid black; border-top: 1px solid black; border-bottom: 1px solid black;">Dikurangi Uang Muka yang telah diterima
                        </td>
                        <td style="border-bottom: 1px solid black; border-top: 1px solid black; vertical-align: top; text-align:left;">
                        </td>
                        <td style="border-bottom: 1px solid black; text-align: left;">Rp.
                    ...
                    <!--Area DPP-->
                    <tr>
                        <td colspan="7" rowspan="1" style="height:25px; padding-left: 4px; vertical-align: middle; border-right:1px solid black;border-top:1px solid black;">Dasar Pengenaan Pajak
                        </td>
                        <td style="border-bottom: 1px solid black; border-top: 1px solid black; vertical-align: top; text-align:left;">
                        </td>
                        <td style="border-bottom: 1px solid black; text-align: left;">Rp.
                   ...
                   <!--Area ppn-->
                   <tr>
                        <td colspan="7" rowspan="1" style="height:25px; padding-left: 4px; vertical-align: middle; border-bottom: 1px solid black; border-right: 1px solid black; border-top: 1px solid black;">PPN = 10% x Dasar Pengenaan Pajak
                        </td>
                        <td style="border-bottom: 1px solid black; border-top: 1px solid black; vertical-align: top; text-align:left;">
                        </td>
                        <td style="border-bottom: 1px solid black; text-align: left;">Rp.
        ...
        <tr>
            ...
            <td style="width:88px; text-align: right; border-bottom:0px dashed;">
                <div style="height: 18px; width: 75px;">
                ${tax.company_address_id and tax.company_address_id.city or ''}
                </div>
            </td>
            <td style="width: 50px; text-align:left; border-bottom:0px dashed;">
                <div style="height: 18px; width: 55px;">, tanggal
                </div>
            </td>
            <%inv_date = date_order_fmt(tax.invoice_date or '') %>
            <td style="width: 135px; text-align: left; padding-right: 2px;  border-bottom:0px dashed;" >
                <div style="height: 18px;">
                ${inv_date}
                </div>
            </td>
            <td style="width: 30px; border-right: 1px solid black;">
            </td>
        </tr>
        <tr>
            <td style="vertical-align: top; border-right: 1px solid black;" colspan="7">
                <div style="height: 28px;">
                <table style="border-collapse: collapse; margin-left: 5px; height: 64px;">
                    <tr height="16px">
                        <td width="71px" style="text-align: center; border-collapse: collapse; border:1px solid black;">Tarif
                        </td>
                        <td colspan="2" rowspan="1" width="151px" style="text-align: center; border-collapse: collapse; border:1px solid black;">DPP
                        </td>
                        <td colspan="2" rowspan="1" width="151px" style="text-align: center; border-collapse: collapse; border: 1px solid black;">Ppn BM
                        </td>
                        <td width="151px">
                        </td>
                    </tr>
                    ...
                    <%lines = _grouped_info + [False, False, False, False]%>
                        %for p in lines[:4]:
                            %if p:
                                    <tr height="16px">
                                        <td style="text-align: right; border-right: 1px solid black; border-left: 1px solid black; padding-right: 5px;">
                                        ${formatLang(p.get('tariff') * 100.0, digits=0)} %
                                        </td>
                                        <td style="vertical-align: top; padding-left: 5px;">Rp.</td>
                                        <td style="text-align: right; border-right: 1px solid black; padding-left: 5px;">
                                        ${formatLang(p.get('tax_base'), digits=0)}
                                        </td>
                                        <td style="vertical-align: top; padding-left: 5px;">Rp.</td>
                                        <td style="text-align: right; border-right: 1px solid black; padding-right: 5px;">
                            ...
                            %else:
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="2" rowspan="1" style="text-align: left; border-bottom: 1px solid black; border-right: 1px solid black; border-left: 1px solid black; padding-left: 5px;">Rp.
                                        </td>
                                        <td colspan="2" rowspan="1" style="text-align: left; border-bottom: 1px solid black; border-right: 1px solid black; border-left: 1px solid black; padding-left: 5px;">Rp.
                                        </td>
                                    </tr>
                    ...
                    <tr>
                        <td colspan="3" style="border-collapse: collapse; border: 1px solid black; width: 257px; height: 16px; padding-left: 10px;">Jumlah
                        </td>
                        <td style="vertical-align: top; padding-left: 5px; border-top: 1px solid black; border-bottom: 1px solid black;">Rp.</td>
                        <td style="text-align: right; border-top: 1px solid black; border-right: 1px solid black; padding-right: 5px; border-bottom: 1px solid black;">${tax.amount_total_ppnbm and formatLang(tax.amount_total_ppnbm, digits=0) or ''}
                        </td> 
                        <td style="width:37px; text-align: right;" colspan="2">
                        </td>
                        <td style="width: 45px; text-align:left; border-bottom:0px dashed;">
                        </td>
                        <td style="width: 5px; border-bottom:0px dashed;">
                        </td>
                        <td style="border-bottom:0px dashed; width: 200px;" colspan="5">Tjiam Wahyu
                        </td>
                        <td style="width: 80px;">
                        </td>
                    </tr>
...
<left><h2 style="width: ${page_width}px; font-size: 8px; margin: 0px; padding: 2px;"><b>**) Coret yang tidak perlu</b></h2></left>
