...
<%preprinted_header_space = 176%>					<!--Blank space untuk area preprinted dari formulir-->
...
<!--================================================================== EDITABLE AREA ===============================================================-->
			...
			<%prod_line_desc = re.sub(r'.*]', "", prod.product_id and prod.product_id.name or prod.name)%>
            ...
            <td colspan="5">
                ...
                <table>
                    <tr>
						...
						%endif
                        <td style="vertical-align: top; width: 800px; font-size:${font_size}px">${xtitle} ${inv.partner_id and inv.partner_id.name or ''|entity}</td>
                        <td></td><td align="right"><font size=1>${inv.user_id.name}</font></td>
                    </tr>
                    <tr>
...
####################################################################################################################################################-->
        ...
        <tr>
            ...
            ${current_page >= total_page and 'Tjiam Wahyu' or ''}
            </div>
            <td>
            </td>
            <td>
