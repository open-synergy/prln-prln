...
<!--==================================== EDITABLE AREA =========================================-->
        ...
        <%prod_line_desc = prod_line_desc + ' : ' + (prod.notes or '-')%>
	<!--%prod_line_desc = prod.notes %-->
...
<body style="font-size: ${font_size}px; font-family: Sans-Serif; margin: 0px">
    ...
    <table cellpadding="2" cellspacing="2" style="height: 1000px;" border=0>
        <tbody>
            <tr>
                <td class="header-row" width="339px">
                    ${helper.embed_logo_by_name('pralon_logo', 166) | n}<br/>
                </td>
                <td class="header-row" width="220px"><br/></td>
                <td class="header-row" style="vertical-align: bottom;text-align: right;" width="388px">
