...
<%column_width_in_chars=[50,14,10,5,15,20,16,16]%>    <!--Lebar masing-masing kolom line item dalam jumlah huruf/karakter-->
...
<%max_note_lines = last_page_footer_lines - 11%>    <!--Jumlah maksimum baris untuk Notes yang multi-line -->
...
%for obj in objects :
    ...
    <% limit = 20 %>
    <% increment = limit %>
    <% currency = obj.pricelist_id and obj.pricelist_id.currency_id and unicode(obj.pricelist_id.currency_id.symbol).encode('ascii', 'xmlcharrefreplace') or '' %>
...
<!--==================================== EDITABLE AREA =========================================-->
        ...
        <%prod_line_desc = re.sub(r'.*]', "", prod.name or (prod.product_id and prod.product_id.name) or '')%>
        ...
        <%str_holder.append(formatLang(prod.price_unit * prod.product_qty))%>
...
<body style="font-size: ${font_size}px; font-family: Sans-Serif; margin: 0px">
                ...
                <td style="vertical-align: top;" colspan="3">
                    ...
                    <table class="references">
                        ...
                        <tr>
                            ...
                            <td class="header-cell">${date_order_fmt(obj.date_approve) or '' | entity}</td>
        ...
        <!--Area untuk pencetakan line item-->
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="info-cell-header" width="100px">Taxes</td>
                            <td class="info-cell-header right" width="70px">Qty</td>
                            <td class="info-cell-header right" width="70px">Unit Price</td>
                            <td class="info-cell-header right" width="150px">Amount</td>
                        </tr>
      ...
      <!--Menentukan-->
                ...
                %for line_no in range (current_line,last_line):
                    %if line_no < total_lines_print:
                        ...
                        <tr>
                            <td class="table_line">${line_item_print[line_no][0] | entity}</td>
                            <td class="table_line">${line_item_print[line_no][1] | entity}</td>
                            <td class="table_line right">${line_item_print[line_no][2] | entity} ${line_item_print[line_no][3] | entity}</td>
                            <td class="table_line right">${line_item_print[line_no][4] | entity}</td>
                            <td class="table_line right">${line_item_print[line_no][5] | n} ${line_item_print[line_no][6] | entity}</td>
                        </tr>
                ...
                <table>
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td width="10px" class="top-cell">${currency | n}</td>
                            <td width="91px" class="top-cell right">${formatLang(obj.amount_untaxed or 0.00) | entity}</td>
                        </tr>
                        <tr>
                            <td></td>
                            <td>Taxes :</td>
                            <td>${currency | n}</td>
                            <td class="right">${formatLang(obj.amount_tax or 0.00) | entity}</td>
                        </tr>
                        <tr>
                            <td></td>
                            <td class="top-cell"><b>Grand Total :</b></td>
                            <td class="top-cell">${currency | n}</td>
                            <td class="top-cell right">${formatLang(obj.amount_total or 0.00) | entity}</td>
                        </tr>
                        <tr>
                            <td class="v-spacer"></td>
                            <td></td>
                        ...
                        <tr>
                            ...
                            ${obj.get_purchase_info_by_name(info_name='Consignee')[obj.id] or '' | entity}
                            </td>
                            <td></td>
                            <td></td>
                        </tr>
                        <tr>
                            ...
                            <td class="extra-info">
                            ${obj.get_purchase_info_by_name(info_name='Shipping Date')[obj.id] or '' | entity}
                            </td>
                            <td></td>
                            <td></td>
                        </tr>
                        <tr>
                            ...
                            <td class="extra-info">
                            ${obj.get_purchase_info_by_name(info_name='Shipping Terms')[obj.id] or '' | entity}
                            </td>
                            <td></td>
                            <td></td>
                        </tr>
                        <tr>
                            ...
                            <td class="extra-info">
                            ${obj.get_purchase_info_by_name(info_name='Payment Terms')[obj.id] or '' | entity}
                            </td>
                            <td></td>
                            <td></td>
                        </tr>
                        <tr>
                            <td colspan="2">
                                <br/>
                                <% _notes_line = [] %>
                                %for line in (obj.notes or '').splitlines():
            ...
            <tr>
                <td style="text-align:center;">
                    Authorized by,
                    <br/><br/><br/><br/><br/>
                    ${signatory(obj.company_id.id) | entity}<br/>
    ...
    <table>
        <tbody>
            <tr>
                <td class="right" colspan="6" rowspan="2" style="vertical-align: bottom;">
